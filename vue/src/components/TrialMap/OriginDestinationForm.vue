...
export default {
  ...
  // new: api key AIzaSyDiKECNn9zmym1vPWnEPDJCcBKBrYUNyhQ  old: AIzaSyCTlYcOo1geGmvoTzPWWOAc-2VjQsNcAGw
  methods: {

    calculateButtonPressed() {
      this.spinner = true;

      const URL = `https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/distancematrix/json?origins=${this.route.origin.lat},${this.route.origin.lng}&destinations=${this.route.destination.lat},${this.route.destination.lng}&key=AIzaSyC-BRJt-VbLguL1yMIx8ee4b1YMrBmxwy4`;
      axios
        .get(URL)
        .then((response) => {
